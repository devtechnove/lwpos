            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="/home" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="/assets/images/logo-dark-devtech.png" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <a href="/home" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="/assets/images/logo-light-devtech.png" alt="" height="17">
                        </span>
                    </a>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center">
               ...
               {{--  <div class="dropdown ms-1 topbar-head-dropdown header-item">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <small><h6 class="dropdown-header">Bienvenido(a) {{ \Auth::user()->name }}</h6></small>
                        <a class="dropdown-item" href="#">
                            <i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                            <span class="align-middle">Mi perfil</span></a>

                             <a class="dropdown-item" href="#"><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Configuración</span></a>

                        <div class="dropdown-divider"></div>
                       <a class="dropdown-item" href="{{ route('logout') }}"
                         onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                        <i class="mdi mdi-logout text-muted fs-16 align-middle me-2 red-text"></i>   {{ __('Salir') }}
                        </a>

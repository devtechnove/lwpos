        ...
        <div class="d-flex align-items-center">
           ...
           {{--  <div class="dropdown ms-1 topbar-head-dropdown header-item">
            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <small class="dropdown-header">Bienvenido {{ \Auth::user()->name }}!</small>
                    <a class="dropdown-item" href="{{ url('usuarios/'.\Auth::id()) }}"><i
                    ...
                    <a class="dropdown-item" href="{{ route('logout') }}"  onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                            class="mdi mdi-logout text-muted fs-16 align-middle me-1 red-text "></i> <span
